...
export function register(server: McpServer) {
  return server.registerTool(
    ...
    {
      description:
        "Scan a project's lockfile for dependency risks. Parses package-lock.json, yarn.lock, pnpm-lock.yaml, requirements.txt, poetry.lock, Cargo.lock, go.sum, Gemfile.lock, pubspec.lock, Pipfile.lock, packages.lock.json, or composer.lock and batch-queries OSV for vulnerabilities across all dependencies.",
      inputSchema: {
        lockfile_content: z.string().describe("Full text content of the lockfile"),
        lockfile_name: z
          .string()
          .describe(
            "Filename to determine format: package-lock.json, yarn.lock, pnpm-lock.yaml, requirements.txt, poetry.lock, Cargo.lock, go.sum, Gemfile.lock, pubspec.lock, Pipfile.lock, packages.lock.json, composer.lock",
          ),
      },
    },
